...
describe('AddProjectQuotaDialogComponent', () => {
  ...
  it('should call _subscribeToQuotaGroupChanges() when _initForm() is called', async () => {
    // @ts-ignore
    const spy = jest.spyOn(component, '_subscribeToQuotaGroupChanges');
  ...
  it('should call detectChanges() in changeDetectorRef when ngAfterContentChecked() is called', async () => {
    // @ts-ignore
    const spy = jest.spyOn(component._changeDetectorRef, 'detectChanges');
  ...
  it('should call next() _unsubscribe when ngAfterContentChecked() is called', async () => {
    // @ts-ignore
    const spy = jest.spyOn(component._changeDetectorRef, 'detectChanges');
  ...
  it('should set projects when subscribed to myProjects in _projectService', async () => {
    jest.spyOn(projectsService, 'myProjects', 'get').mockReturnValue(of(mockProjects));
    component.projects = [];
  ...
  it('should call subscribe() on projects in _projectsService', async () => {
    jest.spyOn(projectsService, 'projects', 'get').mockReturnValue(of(mockProjects));
    const spy = jest.spyOn(projectsService.projects, 'subscribe');
